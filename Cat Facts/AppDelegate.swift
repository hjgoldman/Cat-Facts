...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        //setting up DB
        self.persistentStoreContainer = NSPersistentContainer(name: "CatDataModel")
        ...
        guard let catFactVC = navCongroller.viewControllers.first as? CatFactViewController else {
            fatalError("CatFactViewController not found!")
        }
        catFactVC.managedObjectContext = self.persistentStoreContainer.viewContext
